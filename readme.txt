...
<br><br>
1. Upload 'powr-video-gallery.php' to the '/wp-content/plugins/' directory
<br>
2. Activate the plugin through the 'Plugins' menu in WordPress
<br><br>
To add POWr Video Gallery as a widget, go to **Appearance->Widgets**, and drag POWr Video Gallery to where you'd like it to appear.
<br><br>
To add Video Gallery within a post or a page, simply write the shortcode **[powr-video-gallery label='MY LABEL']** (including the brackets) where you'd like your Video Gallery to appear. Then visit your page!
<br><br>
Want a more detailed tutorial? Visit [How to add Video Gallery to your Wordpress site](http://www.powr.io/tutorials/how-to-add-video-gallery-plugin-to-your-wordpress-site)
